...
// Evaluate the specified transaction.
          const result = await contract.evaluateTransaction('getRecord',req.query['recordId']);
...
// Submit the specified transaction.
        let result= await contract.submitTransaction('submitRecord', req.body.recordType, req.body.doctorId, req.body.doctorName, req.body.doctorMobile, req.body.patientName, req.body.patientMobile, req.body.healthRecord, req.body.date);
